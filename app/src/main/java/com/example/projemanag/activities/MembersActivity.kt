...
import com.example.projemanag.utils.CoroutinesAsyncTask
...
class MembersActivity : BaseActivity() {
    ...
    fun memberAssignSuccess(user: User) {
        ...
        // START
        SendNotificationToUserAsyncTask().execute()
        // END
    }

    private inner class SendNotificationToUserAsyncTask: CoroutinesAsyncTask<Int, Int, String>(){
        ...
        override fun doInBackground(vararg params: Int?): String {
            ...
            try {
                ...
                dataObject.put(Constants.FCM_KEY_TITLE, "Assigned to the Board ${mBoardDetails.name}")
